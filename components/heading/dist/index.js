  ...
  '../../themes/theme-1/dist/index.js'(exports2) {
    ...
    var require_object_assign2 = __commonJS2({
      '../../common/temp/node_modules/.pnpm/object-assign@4.1.1/node_modules/object-assign/index.js'(
        ...
        module22.exports = shouldUseNative()
          ? Object.assign
          : function (target, source) {
              var from;
              var to = toObject(target);
    ...
    function deepmerge2(
      ...
      if (isPlainObject3(target) && isPlainObject3(source)) {
        Object.keys(source).forEach(key => {
          ...
          if (
            isPlainObject3(source[key]) &&
            key in target &&
            isPlainObject3(target[key])
          ) {
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    function getAutoHeightDuration2(height2) {
      ...
      return Math.round(
        (4 + 15 * __pow2(constant2, 0.25) + constant2 / 5) * 10
      );
    }
...
var createStyled = function createStyled2(tag, options) {
  ...
  return function () {
    ...
    var Styled = (0, import_react3.withEmotionCache)(function (
      props,
      cache,
      ref
    ) {
      ...
      if (props.theme == null) {
        ...
        mergedProps.theme = (0, import_react2.useContext)(
          import_react3.ThemeContext
        );
      }
      ...
      newProps.ref = ref;
      var ele = /* @__PURE__ */ (0, import_react2.createElement)(
        finalTag,
        newProps
      );
      var possiblyStyleElement = /* @__PURE__ */ (0,
      import_react2.createElement)(Noop, null);
...
var Heading = ({ children, themeOverride }) => {
  ...
  const mergedTheme = (0, import_react7.useMemo)(
    () =>
      merge_default2({}, import_theme_1.theme, containerTheme, themeOverride),
  ...
  return /* @__PURE__ */ (0, import_react.jsx)(
    ...
    /* @__PURE__ */ (0, import_react.jsx)(
      ...
      __spreadValues(
        ...
        (_d = (_c = mergedTheme.components) == null ? void 0 : _c.heading) ==
          null
          ? void 0
          : _d.defaultProps
      ),
