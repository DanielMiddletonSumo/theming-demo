...
var require_react_is_development = __commonJS({
  "../../common/temp/node_modules/.pnpm/react-is@16.13.1/node_modules/react-is/cjs/react-is.development.js"(exports2) {
    init_react_shim();
    "use strict";
    if (true) {
      (function() {
...
var require_react_is = __commonJS({
  "../../common/temp/node_modules/.pnpm/react-is@16.13.1/node_modules/react-is/index.js"(exports2, module2) {
    init_react_shim();
    "use strict";
    if (false) {
...
var require_ReactPropTypesSecret = __commonJS({
  "../../common/temp/node_modules/.pnpm/prop-types@15.7.2/node_modules/prop-types/lib/ReactPropTypesSecret.js"(exports2, module2) {
    init_react_shim();
    "use strict";
...
var require_checkPropTypes = __commonJS({
  "../../common/temp/node_modules/.pnpm/prop-types@15.7.2/node_modules/prop-types/checkPropTypes.js"(exports2, module2) {
    init_react_shim();
    "use strict";
...
var require_factoryWithTypeCheckers = __commonJS({
  "../../common/temp/node_modules/.pnpm/prop-types@15.7.2/node_modules/prop-types/factoryWithTypeCheckers.js"(exports2, module2) {
    init_react_shim();
    "use strict";
...
var require_prop_types = __commonJS({
  "../../common/temp/node_modules/.pnpm/prop-types@15.7.2/node_modules/prop-types/index.js"(exports2, module2) {
    init_react_shim();
    if (true) {
...
var require_dist = __commonJS({
  "../../themes/theme-1/dist/index.js"(exports2) {
    ...
    var require_react_is_development2 = __commonJS2({
      "../../common/temp/node_modules/.pnpm/react-is@16.13.1/node_modules/react-is/cjs/react-is.development.js"(exports3) {
        "use strict";
        if (true) {
          (function() {
            "use strict";
    ...
    var require_react_is2 = __commonJS2({
      "../../common/temp/node_modules/.pnpm/react-is@16.13.1/node_modules/react-is/index.js"(exports3, module22) {
        "use strict";
        if (false) {
    ...
    var require_object_assign2 = __commonJS2({
      "../../common/temp/node_modules/.pnpm/object-assign@4.1.1/node_modules/object-assign/index.js"(exports3, module22) {
        "use strict";
        var getOwnPropertySymbols = Object.getOwnPropertySymbols;
        var hasOwnProperty10 = Object.prototype.hasOwnProperty;
        var propIsEnumerable = Object.prototype.propertyIsEnumerable;
    ...
    var require_ReactPropTypesSecret2 = __commonJS2({
      "../../common/temp/node_modules/.pnpm/prop-types@15.7.2/node_modules/prop-types/lib/ReactPropTypesSecret.js"(exports3, module22) {
        "use strict";
        var ReactPropTypesSecret = "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED";
    ...
    var require_checkPropTypes2 = __commonJS2({
      "../../common/temp/node_modules/.pnpm/prop-types@15.7.2/node_modules/prop-types/checkPropTypes.js"(exports3, module22) {
        "use strict";
        var printWarning = function() {
        };
        if (true) {
        ...
        var loggedTypeFailures;
        var has;
        function checkPropTypes(typeSpecs, values22, location, componentName, getStack) {
          if (true) {
            for (var typeSpecName in typeSpecs) {
              if (has(typeSpecs, typeSpecName)) {
                var error;
                try {
                  ...
                  error = typeSpecs[typeSpecName](values22, typeSpecName, componentName, location, null, ReactPropTypesSecret);
                } catch (ex) {
                  error = ex;
                }
                if (error && !(error instanceof Error)) {
    ...
    var require_factoryWithTypeCheckers2 = __commonJS2({
      "../../common/temp/node_modules/.pnpm/prop-types@15.7.2/node_modules/prop-types/factoryWithTypeCheckers.js"(exports3, module22) {
        "use strict";
    ...
    var require_prop_types2 = __commonJS2({
      "../../common/temp/node_modules/.pnpm/prop-types@15.7.2/node_modules/prop-types/index.js"(exports3, module22) {
        if (true) {
    ...
    var responsivePropType2 = true ? import_prop_types6.default.oneOfType([
    ...
    function style3(props, keys) {
      ...
      return Object.keys(props).map((prop) => resolveCssProperty2(props, keys, prop, transformer)).reduce(merge_default3, {});
    }
    ...
    function createBreakpoints2(breakpoints) {
      const {
        ...
        unit = "px",
        step = 5
      } = breakpoints, other = _objectWithoutPropertiesLoose2(breakpoints, _excluded9);
      ...
      function between(start, end) {
        ...
        return `@media (min-width:${typeof values22[start] === "number" ? values22[start] : start}${unit}) and (max-width:${(endIndex !== -1 && typeof values22[keys[endIndex]] === "number" ? values22[keys[endIndex]] : end) - step / 100}${unit})`;
      }
      function only(key) {
    ...
    function createTheme3(options = {}, ...args) {
      const {
        ...
        spacing: spacingInput,
        shape: shapeInput = {}
      } = options, other = _objectWithoutPropertiesLoose2(options, _excluded22);
...
The following color spaces are supported: srgb, display-p3, a98-rgb, prophoto-rgb, rec-2020.` : formatMuiErrorMessage(10, colorSpace));
    ...
    function getLuminance2(color2) {
      ...
      rgb = rgb.map((val) => {
        ...
        return val <= 0.03928 ? val / 12.92 : __pow2((val + 0.055) / 1.055, 2.4);
      });
    ...
    function createPalette2(palette2) {
      const { mode = "light", contrastThreshold = 3, tonalOffset = 0.2 } = palette2, other = _objectWithoutPropertiesLoose2(palette2, _excluded32);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
      ...
      const paletteOutput = deepmerge2(_extends2({
    ...
    function createTypography2(palette2, typography2) {
      const _ref = typeof typography2 === "function" ? typography2(palette2) : typography2, {
        ...
        allVariants,
        pxToRem: pxToRem2
      } = _ref, other = _objectWithoutPropertiesLoose2(_ref, _excluded42);
      if (true) {
    ...
    function getAutoHeightDuration2(height2) {
      ...
      return Math.round((4 + 15 * __pow2(constant2, 0.25) + constant2 / 5) * 10);
    }
    function createTransitions2(inputTransitions) {
      const mergedEasing = _extends2({}, easing2, inputTransitions.easing);
      const mergedDuration = _extends2({}, duration2, inputTransitions.duration);
      const create = (props = ["all"], options = {}) => {
        const {
          duration: durationOption = mergedDuration.standard,
          easing: easingOption = mergedEasing.easeInOut,
          delay = 0
        } = options, other = _objectWithoutPropertiesLoose2(options, _excluded52);
        if (true) {
    ...
    function createTheme22(options = {}, ...args) {
      ...
      } = options, other = _objectWithoutPropertiesLoose2(options, _excluded62);
...
var createStyled = function createStyled2(tag, options) {
  ...
  return function() {
    ...
    var Styled = (0, import_react3.withEmotionCache)(function(props, cache, ref) {
      ...
      if (props.theme == null) {
        ...
        mergedProps.theme = (0, import_react2.useContext)(import_react3.ThemeContext);
      }
      ...
      newProps.ref = ref;
      var ele = /* @__PURE__ */ (0, import_react2.createElement)(finalTag, newProps);
      var possiblyStyleElement = /* @__PURE__ */ (0, import_react2.createElement)(Noop, null);
...
// ../../common/temp/node_modules/.pnpm/@emotion+styled@11.6.0_710a1baf939bd0124c2f7745a81f05ad/node_modules/@emotion/styled/dist/emotion-styled.browser.esm.js
var import_react5 = __toModule(require("@emotion/react"));
var tags = [
  "a",
  "abbr",
  "address",
...
// ../../common/temp/node_modules/.pnpm/@mui+styled-engine@5.2.0_c295042f06038c5042b55c2330454282/node_modules/@mui/styled-engine/index.js
var import_react6 = __toModule(require("@emotion/react"));
      ...
      if (value !== null && value !== void 0) {
        if (typeof value === "object") {
          if (propToStyleFunction[styleKey]) {
            css2 = merge_default(css2, getThemeValue_default(styleKey, value, theme2));
          } else {
...
// ../../common/temp/node_modules/.pnpm/@mui+private-theming@5.2.2_8f2a70223edc24c84ceb1eb31a596bed/node_modules/@mui/private-theming/ThemeProvider/ThemeProvider.js
var import_jsx_runtime = __toModule(require("react/jsx-runtime"));
...
function InnerThemeProvider(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_react6.ThemeContext.Provider, {
...
function getAutoHeightDuration(height2) {
  ...
  const constant2 = height2 / 36;
  return Math.round((4 + 15 * __pow(constant2, 0.25) + constant2 / 5) * 10);
}
...
// ../../common/temp/node_modules/.pnpm/@mui+material@5.2.2_303b0097fd95943af88978a904ef5b5d/node_modules/@mui/material/styles/useTheme.js
init_react_shim();
...
var Heading = ({ children, themeOverride }) => {
  var _a, _b;
  const containerTheme = useTheme4();
  const mergedTheme = (0, import_react7.useMemo)(() => merge_default2({}, import_theme_1.theme, containerTheme, themeOverride), [themeOverride, containerTheme]);
  (0, import_react7.useEffect)(() => {
    console.log("heading theme: ", import_theme_1.theme);
  ...
  return /* @__PURE__ */ (0, import_react.jsx)(ThemeProvider_default2, {
    theme: mergedTheme
  }, /* @__PURE__ */ (0, import_react.jsx)(Box_default, {
    component: "h1",
    sx: __spreadValues({
      color: "primary.main",
      border: (theme2) => `${theme2.spacing(1)} solid ${theme2.palette.info.main}`
    }, (_b = (_a = mergedTheme.components) == null ? void 0 : _a.heading) == null ? void 0 : _b.styleOverrides)
  }, children));
};
/*
object-assign
