...
function createBox(options = {}) {
  ...
  const Box2 = /* @__PURE__ */ forwardRef(function Box3(inProps, ref) {
    ...
    return /* @__PURE__ */ _jsx2(BoxRoot, _extends({
      as: component,
      ref,
...
var Heading = ({ children, themeOverride }) => {
  ...
  const mergedTheme = useMemo2(() => merge_default2({}, import_theme_1.theme, containerTheme, themeOverride), [themeOverride, containerTheme]);
  useEffect(() => {
  ...
  return /* @__PURE__ */ jsx(ThemeProvider_default2, {
    theme: mergedTheme
  }, /* @__PURE__ */ jsx(Box_default, {
    component: "h1",
    sx: __spreadValues({
      color: "primary.main",
